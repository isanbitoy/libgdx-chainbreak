...
public class ArrowB extends Arrow
{
    ...
    public ArrowB(GameScreen screen, float rotation, float x, float y)
    {
        super(screen, x, y);
        ...
        for (int i = 0; i < 6; i++)
            frames.add(new TextureRegion(screen.getGame().getArrowB(), i * 32, 0, 32, 32));
    ...
    protected void defineBody()
    {
        ...
        fixtureDef.filter.categoryBits = Constants.ARROW_B_BIT;
